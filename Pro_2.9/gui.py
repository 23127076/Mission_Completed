...
class GUI:
    ...
    def handle_button_click(self, mouse_pos):
        ...
        'auto_mode', 'step_mode', 'toggle_all', 'reset_game', 'new_seed', or 'switch_agent'.
            ...
            if btn["rect"].collidepoint(mouse_pos):
                ...
                if action in ("auto_mode", "step_mode"):
                    if action == "auto_mode":
                        ...
                        self.mode = GameMode.STEP
                        return "step_mode"  # ✅ tell main loop to run one step now
                    ...
                    for btn in self.buttons:
                        if btn["action"] == "switch_agent":
                            btn["label"] = f"Agent: {self.agent_type}"
                    return "switch_agent"
